...
/*
Timing constants for the ball and paddle movements resp 20 and 33
*/
const unsigned long PADDLE_RATE = 33;
const unsigned long BALL_RATE = 20;
const uint8_t PADDLE_HEIGHT = 24;// Paddle height
int MAX_SCORE = 8;// Score max

//decided to play with computer due to the lack of hardware Adam
int CPU_SCORE = 0;//Initialize the score
int PLAYER_SCORE = 0;

//instead of creating screen, implement screen already created
//Adafruit_SSD1331 display = Adafruit_SSD1331(cs, dc, rst);


//void drawCourt();
//ball position and directions
...
};//will be stored in program memory rather than RAM 
